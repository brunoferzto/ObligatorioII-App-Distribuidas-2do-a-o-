...
namespace CompositeControl
{
    public class Composite : WebControl, INamingContainer
    {
        ...
        public void CurSelec(string cod, int costo, int cupos, string nombre, string tipo, DateTime fecha, string emple,
            string contra, string local, string direc, List<string> facil, string otro)

        {
            ...
            txt1.Text = nombre;
            txt2.Text = cod;
            txt4.Text = costo.ToString();
            txt5.Text = cupos.ToString();
            txt6.Text = emple;
            txt7.Text = otro;
            txt10.Text = fecha.ToShortDateString();
            txt8.Text = local;
            txt9.Text = direc;

            _listbox.DataSource = facil;
            _listbox.DataBind();
