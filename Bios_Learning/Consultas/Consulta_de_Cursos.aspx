<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Consulta_de_Cursos.aspx.cs" Inherits="Consulta_de_Cursos" StyleSheetTheme="SkinFile" MasterPageFile="" %>
        ...
        <table style="width:100%;">
            <tr>
                <td class="auto-style3">
                    <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class="auto-style11"><strong>CONSULTA DE CURSOS:</strong></span><strong><br class="auto-style11" />
                    </strong>
                </td>
                ...
                <td class="auto-style3">
                    <table class="auto-style4">
                        ...
                        <asp:ListItem Value="Especializado">Especializados</asp:ListItem>
                            ...
                            <td class="auto-style15"><asp:DropDownList ID="DDLSucursal" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DDLSucursal_SelectedIndexChanged" BackColor="#6699FF" Font-Bold="True" Font-Italic="False" Font-Names="Arial Narrow" ForeColor="#990033">
                    </asp:DropDownList>
                            </td>
                            <td class="auto-style16"></td>
                            <td class="auto-style17">&nbsp;&nbsp; &nbsp;<asp:TextBox ID="txtfecha" runat="server" BackColor="#6699FF" BorderStyle="Solid" Font-Bold="True" Font-Italic="False" Font-Names="Arial Narrow" ForeColor="#990033"></asp:TextBox>
                                <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;
                    ...
                    <asp:Button ID="btnlimpiar" runat="server" Text="Limpiar" OnClick="btnlimpiar_Click" Height="23px" Font-Bold="True" Font-Names="Agency FB" BackColor="Maroon" ForeColor="#66CCFF" />
                &nbsp;&nbsp;</td>
