...
insert into Facilidades values ('Aire Acondicionado','Escuela de Sistemas')
 ...
 INSERT INTO Cursos VALUES ('ProgramadorWeb.Net', 30000,'AAA02','10/04/2020',80,'Escuela de Sistemas','Usuario002')
 INSERT INTO CurCorto VALUES ('AAA02','Programación')

 INSERT INTO Cursos VALUES ('Analista en Infraestructura', 15000, 'AAA03','21/03/2020',50,'Escuela de Sistemas','Usuario001')
INSERT INTO CurEspecializado VALUES ('AAA03', 30)


INSERT INTO Cursos VALUES ('Analista en Contabilidad', 50000, 'BBB01', '10/02/2020', 50, 'Escuela de Economia y Finanzas', 'Usuario003')
INSERT INTO CurCorto VALUES('BBB01', 'Economía')

INSERT INTO Cursos VALUES ('Técnico en Contabilidad', 80000, 'BBB02', '01/10/2020', 40, 'Escuela de Economia y Finanzas', 'Usuario003')
INSERT INTO CurEspecializado VALUES ('BBB02', 30)

INSERT INTO Cursos VALUES ('Analista en Finanzas e Inversiones', 25000,'BBB03', '25/04/2020', 40,'Escuela de Economia y Finanzas', 'Usuario003')
INSERT INTO CurCorto VALUES ('BBB03', 'Economía')


INSERT INTO CURSOS VALUES('Animacion 3D', 80000,'CCC01','10/04/2020',100,'Escuela de Diseño','Usuario004')
INSERT INTO CurEspecializado VALUES ('CCC01',30)

INSERT INTO Cursos VALUES ('Programador de VideoJuegos',80000, 'CCC02', '19/04/2020',100,'Escuela de Diseño','Usuario002')
...
INSERT INTO Inscripcion VALUES (10/10/2019,'AAA01',11111111)
INSERT INTO Inscripcion VALUES (08/09/2019,'AAA01',22222222)

INSERT INTO Inscripcion VALUES (11/10/2019,'BBB01',33333333)
INSERT INTO Inscripcion VALUES (GETDATE(),'BBB01',44444444)
INSERT INTO Inscripcion VALUES (04/10/2019,'BBB02',33333333)
INSERT INTO Inscripcion VALUES (04/04/2017,'BBB02',55555555)


INSERT INTO Inscripcion VALUES (03/02/2018,'CCC02',11111111)
INSERT INTO Inscripcion VALUES (10/08/2019,'CCC02',66666666)
INSERT INTO Inscripcion VALUES (04/01/2020,'CCC03',11111111)
...
as
begin
Select * From CurCorto inner join Cursos on CurCorto.Codigo = Cursos.Codigo  
end
go
...
as
begin
Select * From CurEspecializado inner join Cursos on CurEspecializado.Codigo = Cursos.Codigo 
end
go
...
as
begin
Select * From Empleados Where Empleados.Usuario = @usu and Empleados.Contraseña = @pas and Empleados.Estado = 1
end
go
...
as
begin
if (not exists( Select * From Sucursales Where Sucursales.Nombre = @nom and Sucursales.Estado = 1)) 
return -1
...
Create Procedure ListarInscripcion 
as
begin
